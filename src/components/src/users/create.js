                        ...
                        <div class="signup-content">
                            <div class="signup-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category" className="form-control mb-2"value={name} onChange={e => onInputChange(e)} placeholder='Enter category'  fullWidth required/>
                                </div>

                                <div class="form-group">
                                    <label for="email"> </label>
                                    <input type="text" name="desc"  value={desc} className="form-control mb-2"  onChange={e => onInputChange(e)} placeholder='Enter description' type='text' fullWidth required/>
                                </div>
